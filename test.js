  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
        return auctionInstance.revealWinners(0, {from: accounts[0] /*<CODE HERE>*/
    }).then(function(result) {
      /**********
      ...
      ***********/
      return auctionInstance.revealWinners(1, {from: accounts[0]/*<CODE HERE>*/
    }).then(function(result) {
      /**********
      ...
      ***********/
      return auctionInstance.revealWinners(2, {from: accounts[3] /*<CODE HERE>*/
    }).then(function(result) {
      /**********
